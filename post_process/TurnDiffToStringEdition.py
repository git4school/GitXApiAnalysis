...
class TurnDiffToStringEdition(PostProcessModifier):
    ...
    def _process(self, statement: Statement, diffpart: DiffPart, **kargs):
        ...
        while (
            ...
            and content[0][insertion_begin_index] == content[1][insertion_begin_index]
        ):
            insertion_begin_index += 1
        ...
        interval = [
            content[0][insertion_begin_index : len(content[0]) - insertion_end_index],
            content[1][insertion_begin_index : len(content[1]) - insertion_end_index],
        ]
        ...
        if count_quote(interval[0]) % 2 != 0 or count_quote(interval[1]) % 2 != 0:
            return
